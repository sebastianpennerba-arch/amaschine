...
/* ----------------------------------------------------------
   META AUTH IMPORT (Pfad korrigiert)
-----------------------------------------------------------*/
// Fehlerkorrektur: relativen Pfad ("./packages/...") auf absoluten Pfad ("/packages/...")
// umgestellt, damit MetaAuth auch funktioniert, wenn die App unter einem Subpfad läuft.
